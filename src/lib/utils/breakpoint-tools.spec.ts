...
import {RAW_DEFAULTS} from '../media-query/breakpoints/break-points';
...
describe('breakpoint-tools', () => {
  ...
  describe('validation', () => {
    ...
    it('should auto-validate the RAW_DEFAULTS', () => {
      let xsBp: BreakPoint = RAW_DEFAULTS[0];
      let gtLgBp: BreakPoint = RAW_DEFAULTS[RAW_DEFAULTS.length - 2];
      let xlBp: BreakPoint = RAW_DEFAULTS[RAW_DEFAULTS.length - 1];
